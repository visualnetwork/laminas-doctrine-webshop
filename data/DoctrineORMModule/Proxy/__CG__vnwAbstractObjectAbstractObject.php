...
namespace DoctrineORMModule\Proxy\__CG__\vnw\AbstractObject;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class AbstractObject extends \vnw\AbstractObject\AbstractObject implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'vnw\\AbstractObject\\AbstractObject' . "\0" . 'Id', '' . "\0" . 'vnw\\AbstractObject\\AbstractObject' . "\0" . 'Active', '' . "\0" . 'vnw\\AbstractObject\\AbstractObject' . "\0" . 'LastModified', '' . "\0" . 'vnw\\AbstractObject\\AbstractObject' . "\0" . 'Creation', '' . "\0" . 'vnw\\AbstractObject\\AbstractObject' . "\0" . 'Deleted', '' . "\0" . 'vnw\\AbstractObject\\AbstractObject' . "\0" . 'Version', '' . "\0" . 'vnw\\AbstractObject\\AbstractObject' . "\0" . 'isDeletable', '' . "\0" . 'vnw\\AbstractObject\\AbstractObject' . "\0" . 'Creator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AbstractObject $proxy) {
